...
public abstract class BaseClass {
    ...
    public StopWatch testExecutionTime=new StopWatch();
...
//          Below line is useful to remote the exception to WebSocket issue
...
//            options.addArguments("--headless");
    ...
    public void tearDownMethod(ITestResult result, Method method) {
        ...
        double seconds=(double) testExecutionTime.getTime()/1000.0;
        test.log(Status.INFO,"Time taken to execute this test was : "+seconds+" Seconds");
        test.log(Status.INFO, "Test_Case Name was : " + method.getName() + " : Browser was : " + TestBedBrowser);
