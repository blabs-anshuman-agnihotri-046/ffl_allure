...
//		writer.print("<center><h1><img src='https://www.benthonlabs.com/images/favicon.png' alt='Image'></h1></center>");
		writer.print("<div class=\"row\" style=\"display:flex;flex-direction: row;border: 1px solid;width: 37%;margin-left: 31%;border-radius: 7px;\">\n" +
				"    <div class=\"col-md-heading\" style=\"width: 56%;\">\n" +
				"        <h2 style=\"/* text-align: right; */margin-top: 5%;font-size: 31px;margin-left: 19%;\">Benthon Labs</h2>\n" +
				"    <u><h2 style=\"margin-top: -6%;font-size: 22px;margin-left: 28%;\">Automation</h2></u><p style=\"margin-top: -2%;font-size: 18px;margin-left: 32%;\">FFL 360</p></div>\n" +
				"    <div class=\"col-md-logo\" style=\"\n" +
				"    margin-left: 11%;\n" +
				"    width: 25%;\n" +
				"\">\n" +
				"    <img src=\"https://www.benthonlabs.com/images/favicon.png\" alt=\"Image\" style=\"width: 127px;margin-left: 4%;\"></div></div>");
